...
export default async function Settings() {
  ...
  return (<><h1 className="text-[22px] font-semibold mb-1">Settings</h1>
    <CandidateCountries initial={ws?.candidate_countries ?? []} />
    <h2 className="text-[18px] font-semibold mb-1">Sources</h2><p className="text-ink3 mb-3">What Radar reads every morning. Admin only. Seeded from seeds/sources.csv via <code>npm run seed</code>.</p>

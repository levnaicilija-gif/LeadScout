...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (<div className="grid grid-cols-[232px_1fr] min-h-screen">
    <nav className="bg-rail text-railink p-4 flex flex-col gap-0.5 sticky top-0 h-screen">
      ...
      <Item href="/app/today" label="Today" /><Item href="/app/radar" label="Leads" count={leads ?? 0} /><Item href="/app/verify" label="Verify" count="drop" /><Item href="/app/pitch" label="Pitch" count="reverse" /><Item href="/app/candidates" label="Candidates" count={cands ?? 0} /><Item href="/app/campaigns" label="Campaigns" count={camps ?? 0} />
